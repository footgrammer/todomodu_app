...
import 'package:todomodu_app/features/todo/presentation/providers/todo_stream_by_id_provider.dart';
...
class TodoDetailPage extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final asyncTodo = ref.watch(todoStreamByIdProvider(Tuple2(projectId, todoId)));
    final asyncSubtasks = ref.watch(subtaskStreamProvider((projectId, todoId)));
    final projectAsync = ref.watch(projectProvider(projectId));

    return asyncTodo.when(
      loading: () => const Scaffold(body: Center(child: CircularProgressIndicator())),
      error: (e, _) => Scaffold(body: Center(child: Text('할 일 로딩 실패: $e'))),
      data: (todo) {
                          ...
                          builder: (ctx) => Dialog(
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  Text('할 일 삭제하기', style: AppTextStyles.header4.copyWith(color: AppColors.grey800), textAlign: TextAlign.center),
                                  const SizedBox(height: 8),
                                  Text('할 일을 삭제하시겠습니까?', style: AppTextStyles.body2.copyWith(color: AppColors.grey800), textAlign: TextAlign.center),
                    ...
                    itemBuilder: (context) => [
                      PopupMenuItem(
                        ...
                        child: Align(
                          ...
                          child: Text('할 일 수정하기', style: AppTextStyles.body2.copyWith(color: AppColors.grey800)),
                        ),
                      ),
                      PopupMenuItem(
                        value: 'delete',
                        ...
                        child: Align(
                          alignment: Alignment.centerLeft,
                          child: Text('할 일 삭제하기', style: AppTextStyles.body2.copyWith(color: AppColors.grey800)),
                        ),
                      ),
                    ],
                  ),
                  ...
                  children: [
                    Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(todo.title, style: AppTextStyles.header2.copyWith(color: AppColors.grey800)),
                          ...
                          const SizedBox(height: 24),
                          Text('할 일 목록', style: AppTextStyles.subtitle1.copyWith(color: AppColors.grey800)),
                    ...
                    Expanded(
                      child: Container(
                        ...
                        decoration: const BoxDecoration(color: AppColors.grey75),
